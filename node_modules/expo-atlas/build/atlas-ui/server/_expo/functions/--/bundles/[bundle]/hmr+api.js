...
__d((function(g,r,i,a,m,e,d){Object.defineProperty(e,"__esModule",{value:!0}),e.GET=async function(n,t){try{const n=(0,s.getSource)();return n.hasHmrSupport()?Response.json(n.getBundleHmr(t.bundle)):Response.json({error:'HMR not supported'},{status:406})}catch(s){return Response.json({error:s.message},{status:406})}};var s=r(d[0])}),1700,[1692]);
module.exports = __r(1700);