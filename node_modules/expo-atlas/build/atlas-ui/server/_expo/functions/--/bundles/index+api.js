...
__d((function(g,r,i,a,m,e,d){Object.defineProperty(e,"__esModule",{value:!0}),e.GET=async function(){try{const n=(await(0,t.getSource)().listBundles()).map((t=>({...t,entryPoint:t.entryPoint.replace(t.sharedRoot,'').replace(/\\+/g,'/').replace(/^\//,'')})));return Response.json(n)}catch(t){return Response.json({error:t.message},{status:406})}};var t=r(d[0])}),1691,[1692]);
