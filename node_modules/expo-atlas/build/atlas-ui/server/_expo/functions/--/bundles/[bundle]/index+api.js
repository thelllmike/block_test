...
__d((function(g,r,i,a,m,e,d){Object.defineProperty(e,"__esModule",{value:!0}),e.GET=async function(t,s){try{return Response.json(await(0,n.getSource)().getBundle(s.bundle))}catch(n){return Response.json({error:n.message},{status:406})}};var n=r(d[0])}),1699,[1692]);
module.exports = __r(1699);